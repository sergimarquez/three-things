    ...
    <div className="max-w-4xl mx-auto animate-[fadeIn_0.3s_ease-out] space-y-6">
      ...
      <div className="bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200 rounded-2xl p-6 md:p-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-2xl font-semibold text-stone-900 mb-1">Top Moments of {selectedYear}</h2>
            <p className="text-sm text-stone-600">
              {topMoments.length === 0 
                ? "No moments available yet" 
                : `${topMoments.length} special ${topMoments.length === 1 ? 'moment' : 'moments'} from your monthly reviews`}
            </p>
          </div>
        </div>
        {topMoments.length > 0 && (
